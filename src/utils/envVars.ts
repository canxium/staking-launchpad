...
export const TESTNET_LAUNCHPAD_NAME     = process.env.REACT_APP_TESTNET_LAUNCHPAD_NAME || 'Praseody';
...
export const CONTRACT_ADDRESS           = IS_MAINNET ? '0xE616698D7c13E46C538f380da7b67E8FA7929a24' : process.env.REACT_APP_CONTRACT_ADDRESS;
